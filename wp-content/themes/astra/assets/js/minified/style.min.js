var astraGetParents = function(e, t) {
    ...
    astraTriggerEvent = ((() => {
        ...
        t = new CustomEvent(t, 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {}), e.dispatchEvent(t)
    });
astraSmoothScroll = function(e, t) {
    ...
    for (var e, t, a, n, s, r = document.querySelectorAll(".main-header-menu-toggle"), o = {}, l = function() {
        ...
        }, i = (l(), AstraToggleSubMenu = function() {
            ...
            if (console.warn("AstraToggleMenu() function has been deprecated since version 1.6.5 or above of Astra Theme and will be removed in the future. Use AstraToggleSubMenu() instead."), 0 < e.length)
                for (var t = 0; t < e.length; t++) e[t].removeEventListener("click", AstraToggleSubMenu), e[t].addEventListener("click", AstraToggleSubMenu, !1)
        }, AstraToggleSetup = function() {
            var e = document.querySelectorAll(".main-header-bar-navigation");
            if (0 < r.length)
                for (var t, a = 0; a < r.length; a++)
                    if (r[a].setAttribute("data-index", a), o[a] || (o[a] = r[a], r[a].removeEventListener("click", astraNavMenuToggle), r[a].addEventListener("click", astraNavMenuToggle, !1)), void 0 !== e[a] && 0 < (t = document.querySelector("header.site-header").classList.contains("ast-menu-toggle-link") ? e[a].querySelectorAll(".ast-header-break-point .main-header-menu .menu-item-has-children > .menu-link, .ast-header-break-point ul.main-header-menu .ast-menu-toggle") : e[a].querySelectorAll("ul.main-header-menu .ast-menu-toggle")).length)
                        for (var n = 0; n < t.length; n++) t[n].removeEventListener("click", AstraToggleSubMenu), t[n].addEventListener("click", AstraToggleSubMenu, !1)
            ...
            "INPUT" !== document.activeElement.tagName && (l(), AstraToggleSetup())
        }), document.addEventListener("DOMContentLoaded", function() {
            var e, t;
            for (AstraToggleSetup(), e = document.querySelectorAll(".navigation-accessibility"), t = 0; t <= e.length - 1; t++) e[t] && (e => {
                if (e) {
        ...
        }), t = (e = navigator.userAgent).match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i) || [], /trident/i.test(t[1]) ? h = /\brv[ :]+(\d+)/g.exec(e) || [] : "Chrome" === t[1] && null != (h = e.match(/\bOPR|Edge\/(\d+)/)) || (t = t[2] ? [t[1], t[2]] : [navigator.appName, navigator.appVersion, "-?"], null != (h = e.match(/version\/(\d+)/i)) && t.splice(1, 1, h[1]), e = document.body, "Safari" === t[0] && t[1] < 11 && e.classList.add("ast-safari-browser-less-than-11")), document.getElementsByClassName("astra-search-icon")), c = 0; c < i.length; c++) i[c].onclick = function(e) {
        var t;
    ...
    function d() {
        var e = this || "";
        if (e && !e.classList.contains("astra-search-icon") && -1 !== String(e).indexOf("#")) {
            var t = e.parentNode;
    ...
    if (document.querySelectorAll(".search-field").forEach(e => {
        ...
        }, "querySelector" in document && "addEventListener" in window && ((a = document.body).addEventListener("mousedown", function() {
            a.classList.add("ast-mouse-clicked")
        }), a.addEventListener("keydown", function() {
            a.classList.remove("ast-mouse-clicked")
        ...
        let s = e => {
            ...
            e = e => {
                ...
                a && ((a = a.querySelectorAll("div[data-stick-support]")) && a.forEach(e => {
                    t += e.clientHeight
                }), a = e.target.closest("a").hash) && (a = (a = document.querySelector(a)) && s(a) - t) && astraSmoothScroll(e, a)
            },
            t = [];
        var h = document.querySelectorAll('a[href*="#"]:not([href="#"]):not([href="#0"]):not([href*="uagb-tab"]):not(.uagb-toc-link__trigger):not(.skip-link):not(.nav-links a):not([href*="tab-"])');
        if (h)
            for (var v of h) v.href.split("#")[0] !== location.href.split("#")[0] ? t.push({
                hash: v.hash,
                url: v.href.split("#")[0]
            }) : "" !== v.hash && v.addEventListener("click", e);
        window.addEventListener("DOMContentLoaded", e => {
            for (var a of t)
                if (window.location.href.split("#")[0] === a.url) {
                    var n = document.querySelector(".site-header");
                    let t = 0;
                    (n = n.querySelectorAll("div[data-stick-support]")) && n.forEach(e => {
                        t += e.clientHeight
                    }), (n = document.querySelector(a.hash)) && (a = s(n) - t) && astraSmoothScroll(e, a)
                }
        })
    }
    astra.is_scroll_to_top && (n = document.querySelector("#page header"), s = document.getElementById("ast-scroll-top"), astScrollToTopHandler(n, s), window.addEventListener("scroll", function() {
        astScrollToTopHandler(n, s)
